                ...
                chrome.scripting.executeScript({
                    ...
                    function: function() {
                        return {
                            ...
                            nodeId: localStorage.getItem('latestNodeId')
                        };
                    }
                }, function(result) {
                    if (result && result[0].result.token) {
                        ...
                        const config = {
                            usertoken: result[0].result.token,
                            nodes: [
                                {
                                    nodeId: result[0].result.nodeId || '',
        ...
        function(details) {
            try {
                ...
                if (nodeId && nodeId.startsWith('12D3')) {
                    localStorage.setItem('latestNodeId', nodeId);
                }
            } catch (e) {
